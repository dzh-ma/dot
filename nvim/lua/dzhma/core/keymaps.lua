...
vim.keymap.set('n', '<Leader>k', '<cmd>bdelete<CR>', { noremap = true, silent = true})          -- regular buffer deletion

vim.keymap.set('n', '<Leader>x', '<cmd>highlight clear @operator.latex<CR>', { noremap = true, silent = true })
